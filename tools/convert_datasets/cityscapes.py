...
def parse_args():
    ...
    parser.add_argument("--cityscapes_path", default="/disk3/zhang_runtong/datasets/cityscapes", help="cityscapes data path")
    parser.add_argument("--gt-dir", default="gtFine", type=str)
    parser.add_argument("-o", "--out-dir", default="Output", help="output path")
...
def main():
    ...
    if args.nproc > 1:
        mmengine.track_parallel_progress(convert_json_to_label, poly_files, args.nproc)
    else:
